...
import 'package:careme/Screen/coba.dart';
import 'package:careme/model/viewmodel/Psikologhandler.dart';
import 'package:flutter/material.dart';
import 'package:careme/Screen/chat_psikolog.dart';
                        ...
                        child: Row(
                          ...
                          children: [
                            Stack(
                              ...
                              children: [
                                Image(
                                  image: NetworkImage(psikologProvider.lspsikolog[index].image),
                                  fit: BoxFit.cover,
                                  height: 50,
                                ),
                                Text(
                            ...
                            Stack(
                              children: [
                                ...
                                Container(
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      ...
                                      Text(
                                        psikologProvider.lspsikolog[index].rating.toString(),
                                        style: TextStyle(
                                            fontWeight: FontWeight.bold,
                                            fontSize: 15,
                                            color: Colors.black),
                                ...
                                Text(
                                  psikologProvider.lspsikolog[index].harga.toString(),
                                  style: TextStyle(
                                      fontSize: 16,
                                      color: Colors.black,
                                      fontWeight: FontWeight.bold,
                                ...
                                Container(
                                  ...
                                  child: RaisedButton(
                                    ...
                                    onPressed: () {
                                        ...
                                        'appId': 'a1994bbbf20fecbff0854637c915efd5',
                                        };
